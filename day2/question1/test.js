...
describe("words()", function() {
  ...
  it("handles properties that exist on Object's prototype", function() {
    var expectedCounts = { reserved: 1, words : 1, like :1,  prototype: 1, and : 1, String: 1,  "ok?": 1};
    expect(a.words("reserved words like prototype and String ok?")).toEqual(expectedCounts);
  });
});
})();